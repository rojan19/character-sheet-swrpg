        ...
        return (
            <div className="container text-center">
                <div className="row">
                    ...
                    <div className="col-1"><img src="../img/dice/yellow.png" width="20px"/></div>
                    <div className="col-3"><img src="../img/dice/green.png" width="20px" />
                        <img src="../img/dice/yellow.png" width="20px" className="ml-2"/></div>
                    <div className="col-1"><img src="../img/dice/red.png" width="20px" className=""/></div>
                    <div className="col-1"></div>
                </div>
...
function SkillsList(props) {
    ...
    const entriesList = skillsArray.map( skill =>
        <div className="row" key={skill}>
            ...
            <div className="col-3">
                <img src="../img/dice/green.png" width="30px"/>
                {getGreen(getAbility(skill, abilities), skillsObject[skill])}
                <img src="../img/dice/yellow.png" width="30px" className="ml-1 mr-1"/>
